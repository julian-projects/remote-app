...
export const getDevices = async () => {
    const response = await fetch('http://localhost:3333/devices');
    if (!response.ok) {
...
export const useGetDevices = () => {
    return useQuery<IFrontendDevice[]>({
        queryKey: ['devices'],
        queryFn: getDevices,
    });
};
...
export const getDevice = async (id: string) => {
    const response = await fetch(`http://localhost:3333/devices/${id}`);
    if (!response.ok) {
        throw new Error('Network response was not ok');
    }
    return response.json();
...
export const postShutdown = async (id: string) => {
    const response = await fetch(
        `http://localhost:3333/settings/shutdown/${id}`,
        { method: 'POST' }
    );
    if (!response.ok) {
        throw new Error('Network response was not ok');
...
export const postRestart = async (id: string) => {
    const response = await fetch(
        `http://localhost:3333/settings/restart/${id}`,
        { method: 'POST' }
    );
    if (!response.ok) {
        throw new Error('Network response was not ok');
...
export const postDisconnect = async (id: string) => {
    const response = await fetch(
        `http://localhost:3333/settings/disconnect/${id}`,
        { method: 'POST' }
    );
    if (!response.ok) {
        throw new Error('Network response was not ok');
...
export const postFormat = async (id: string) => {
    const response = await fetch(
        `http://localhost:3333/settings/format/${id}`,
        { method: 'POST' }
    );
    if (!response.ok) {
        throw new Error('Network response was not ok');
